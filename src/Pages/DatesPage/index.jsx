...
export default function Dates() {
  ...
  /*const calculateEndDateForPages = (sdate, maxpages, FirstPageData, LayoutData, CalendarData, AddinsData) => {
    ...
    let edate = new Date(sdate); // Copy the st

    // Recalculate pages using the updated edate
    const Pages = calculatePages(sdate, edate, FirstPageData, LayoutData, CalendarData, AddinsData);
    ...
    // Initial assumptions
    edate.setDate(startdate.getDate() + extraDays);
    console.log("extraDays=>",extraDays, sdate, edate)
    return edate;
  };*/
          ...
          <Box className="PageInnerBox">
            ...
            <Box className="RightPanelBox">
              ...
              <Box sx={{ display: startEndDrop ? "block" : "none" }} className="StartEndCoverBox">
                ...
                <Box className="shipInfo">Planners will print and ships in 10 days.</Box>
