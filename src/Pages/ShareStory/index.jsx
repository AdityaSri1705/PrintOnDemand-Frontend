        ...
        <Box className="ShareImageBox">
          ...
          <Box className="shareImageSubBox">
            <Box className="imageBox1">
              <img className='BoxImage' src={image13}  alt="" />
            </Box>
            <Box className="imageBox1R bi1 ">
              <Box className="imageBox1RSub imageBox1RSub-a"><img className='BoxImage' src={image12} alt="" /></Box>
              <Box className="imageBox1RSub imageBox1RSub-b"><img className='BoxImage' src={image7} alt="" /></Box>
              <Box className="imageBox1RSub imageBox1RSub-c"><img className='BoxImage' src={image11} alt="" /></Box>
              <Box className="imageBox1RSub imageBox1RSub-d"><img className='BoxImage' src={image4} alt="" /></Box>
              <Box className="imageBox1RSub imageBox1RSub-e"><img className='BoxImage' src={image5} alt="" /></Box>
              <Box className="imageBox1RSub imageBox1RSub-f"><img className='BoxImage' src={image9} alt="" /></Box>
            </Box>
          </Box>
          ...
          <Box className="shareImageSubBox shareImageSubBox2">
            ...
            <Box className="imageBox1R bi2">
              <Box className="imageBox1RSub imageBox1RSub-a"><img className='BoxImage' src={image8} alt="" /></Box>
              <Box className="imageBox1RSub imageBox1RSub-b"><img className='BoxImage' src={image2} alt="" /></Box>
              <Box className="imageBox1RSub imageBox1RSub-c"><img className='BoxImage' src={image6} alt="" /></Box>
              <Box className="imageBox1RSub imageBox1RSub-d"><img className='BoxImage' src={image4} alt="" /></Box>
              <Box className="imageBox1RSub imageBox1RSub-e"><img className='BoxImage' src={image8} alt="" /></Box>
              <Box className="imageBox1RSub imageBox1RSub-f"><img className='BoxImage' src={image9} alt="" /></Box>
            </Box>
