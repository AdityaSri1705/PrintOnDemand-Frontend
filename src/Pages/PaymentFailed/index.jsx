    ...
    <>
      ...
      <Box className="cartContainer">
        ...
        <Box className="cartTopLogo">
          ...
          <Typography className='cartHeaderSubtotal'>Payment Failed</Typography>
            
          <Box className="PaymentArea" > 
              <Typography className='PaymentText3'>Sorry!</Typography>
              <Typography className='PaymentText1'>Payment procees is failed.</Typography>

              <Box className="PaymentTextTab">
                <Typography mr={1} className='PaymentText1'>Please try again to make payment</Typography>
                <Typography onClick={() => navigate('/payment')} className='PaymentText2 pointer'>click here</Typography>
              </Box>
          </Box>
